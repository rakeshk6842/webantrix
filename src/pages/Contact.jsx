  ...
  return (
    <div style={{maxWidth: '1100px', margin: '40px auto', padding: '0 24px'}}>
      ...
      <div style={{textAlign: 'center', marginBottom: '60px'}}>
        ...
        <h1 style={{fontSize: '3rem', fontWeight: 800, color: '#1a1a2e', margin: '0 0 16px 0', lineHeight: 1.2}}>Let's Start a Conversation</h1>
        <p style={{fontSize: '1.15rem', color: '#4a4a68', margin: '0 auto', maxWidth: '600px', lineHeight: 1.7}}>Have a project in mind? We'd love to hear from you. Send us a message and we'll respond as soon as possible.</p>
      </div>

      {/* Contact Cards Row */}
      <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginBottom: '60px'}}>
        <div style={{background: 'linear-gradient(135deg, #fff 0%, var(--primary-light) 100%)', padding: '32px', borderRadius: '16px', textAlign: 'center', border: '1px solid rgba(230, 57, 70, 0.1)', transition: 'all 0.3s ease'}}>
        ...
        <div style={{background: 'linear-gradient(135deg, #fff 0%, rgba(255, 107, 53, 0.08) 100%)', padding: '32px', borderRadius: '16px', textAlign: 'center', border: '1px solid rgba(255, 107, 53, 0.1)', transition: 'all 0.3s ease'}}>
        ...
        <div style={{background: 'linear-gradient(135deg, #fff 0%, rgba(157, 78, 221, 0.08) 100%)', padding: '32px', borderRadius: '16px', textAlign: 'center', border: '1px solid rgba(157, 78, 221, 0.1)', transition: 'all 0.3s ease'}}>
